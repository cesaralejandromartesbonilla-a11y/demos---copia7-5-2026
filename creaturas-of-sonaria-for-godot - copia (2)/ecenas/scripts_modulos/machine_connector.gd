extends CollisionObject3D # Funciona tanto si usas StaticBody3D como RigidBody3D
class_name MachineConnector

@export var is_generator: bool = false
@export var generator_component: PowerGeneratorComponent # Solo si es generador
@export var receiver_component: PowerReceiverComponent   # Solo si es consumidor

# --- Configuración Visual ---
@export var cable_material: Material 
@export var connection_point: Marker3D # De donde sale el cable visual
@export var state_light_mesh: MeshInstance3D # La luz indicadora del enchufe
@export var highlight_mesh: MeshInstance3D # El brillo de selección
...
var network_id: int = -1 # Para el futuro sistema de redes separadas
