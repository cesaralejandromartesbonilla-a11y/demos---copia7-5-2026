...
@export var transmitter_component: Node # Asignar el CommandCenter
@export var receiver_component: Node    # Asignar el LogicReceiverComponent
...
# --- Variables de Red ---
var my_grid # Ref al objeto red en tu LogicManager (si tienes uno) o red local
